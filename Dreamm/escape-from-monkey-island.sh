...
#Game        : Escape from Monkey Isanld
#
...
#              1: Get Game file(s) either an Archived Exe Installer or EXE installer 
#              2: Create Game folder  in ROMS/PC add exe extenstion to folder name (ESDE needs this)
#              2: Download innoextract and extraxt (URL ddefind in INNO_URL)
