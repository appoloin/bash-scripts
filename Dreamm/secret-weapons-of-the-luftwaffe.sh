#!/bin/bash
#Game        : Secret Weapons of the Luftwaffe
#
#Source      : Archiive
#
#Runner      : Dreamm
...
GAME_NAME="lec-swotl.exe"
TEMP_FOLDER="$ROMs_FOLDER/$GAME_NAME/temp"
DREAMM_PATH="$HOME/Applications/dreamm/dreamm"
DREAMM_CONF_PATH_1="$HOME/.local/share/Aaron Giles/DREAMM/install/lec-swotl"
DREAMM_CONF_PATH="$DREAMM_CONF_PATH_1/pc-2.2cd-en-missions"
