#!/bin/bash
#Game        : Star Wars - Rebel Assault II
#
#Source      : Archiive
#
#Runner      : Dreamm
...
GAME_NAME="lec-rebel2.exe"
TEMP_FOLDER="$ROMs_FOLDER/$GAME_NAME/temp"
DREAMM_PATH="$HOME/Applications/dreamm/dreamm"
DREAMM_CONF_PATH_1="$HOME/.local/share/Aaron Giles/DREAMM/install/lec-rebel2"
DREAMM_CONF_PATH="$DREAMM_CONF_PATH_1/pc-fa1.09-en-win"
