#!/bin/bash
#Game        : Indiana Jones and the Fate of Atlantis - The Action Game
#
#Source      : Archiive
#
#Runner      : Dreamm
...
GAME_NAME="lec-indy4-action.exe"
TEMP_FOLDER="$ROMs_FOLDER/$GAME_NAME/temp"
DREAMM_PATH="$HOME/Applications/dreamm/dreamm"
DREAMM_CONF_PATH_1="$HOME/.local/share/Aaron Giles/DREAMM/install/lec-indy4-action"
