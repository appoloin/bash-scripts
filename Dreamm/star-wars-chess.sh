...
GAME_NAME="swt-swchess.exe"
TEMP_FOLDER="$ROMs_FOLDER/$GAME_NAME/temp"
DREAMM_PATH="$HOME/Applications/dreamm/dreamm"
DREAMM_CONF_PATH_1="$HOME/.local/share/Aaron Giles/DREAMM/install/swt-swchess"
DREAMM_CONF_PATH="$DREAMM_CONF_PATH_1/pc-1.0"
