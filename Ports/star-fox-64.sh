...
ENGINE_URL="https://www.dropbox.com/scl/fi/9v85wqvmqa557srhg6l0e/Starfox_64_Recompiled-1.0.3-anylinux-x86_64.AppImage?rlkey=2kntrqum45mhzx6ck2stah4bl&st=t67a7rcq&dl=1"
ENGINE_EXE="Starfox_64_Recompiled-1.0.3-anylinux-x86_64.AppImage"
ENGINE_DATA=""
FILE_FILTER=""
...
main(){
    ...
    touch "$ROMs_FOLDER/$GAME_NAME/portable.txt"
