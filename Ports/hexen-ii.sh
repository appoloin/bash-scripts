...
ENGINE_NAME="net.sourceforge.uhexen2.uhexen2"
ENGINE_DATA="$HOME/.var/app/net.sourceforge.uhexen2.uhexen2/.hexen2"
FILE_FILTER=""
...
main(){
    ...
    find "$ROMs_FOLDER/$GAME_NAME"  -type d  -name "data1"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME" \;
    find "$ROMs_FOLDER/$GAME_NAME/data1/Hexen.rc"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/hexen.rc" \;

    find "$ROMs_FOLDER/$GAME_NAME/data1/Hexen.rc"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/hexen.rc" \;
    mkdir "$ROMs_FOLDER/$GAME_NAME/data1/music"
    find "$TEMP_FOLDER/music/Track02.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casa1.ogg" \;
    find "$TEMP_FOLDER/music/Track03.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casa2.ogg" \;
    find "$TEMP_FOLDER/music/Track04.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casa3.ogg" \;
    find "$TEMP_FOLDER/music/Track05.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casa4.ogg" \;
    find "$TEMP_FOLDER/music/Track06.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/egyp1.ogg" \;
    find "$TEMP_FOLDER/music/Track07.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/egyp2.ogg" \;
    find "$TEMP_FOLDER/music/Track08.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/egyp3.ogg" \;
    find "$TEMP_FOLDER/music/Track09.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/meso1.ogg" \;
    find "$TEMP_FOLDER/music/Track10.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/meso2.ogg" \;
    find "$TEMP_FOLDER/music/Track11.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/meso3.ogg" \;
    find "$TEMP_FOLDER/music/Track12.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/roma1.ogg" \;
    find "$TEMP_FOLDER/music/Track13.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/roma2.ogg" \;
    find "$TEMP_FOLDER/music/Track14.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/roma3.ogg" \;
    find "$TEMP_FOLDER/music/Track15.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casb1.ogg" \;
    find "$TEMP_FOLDER/music/Track16.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casb2.ogg" \;
    find "$TEMP_FOLDER/music/Track17.ogg"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/data1/music/casb3.ogg" \;


    # Link flatpak data folder to GAME_NAME, Engine can now see games 
    rm -Rf "$ENGINE_DATA/data1"    #remove old game files 
    mkdir -p "$ENGINE_DATA"   #make sure there is folder to link with
    ln -s -f -n "$ROMs_FOLDER/$GAME_NAME/data1" "$ENGINE_DATA/data1"   # Link the folders 
