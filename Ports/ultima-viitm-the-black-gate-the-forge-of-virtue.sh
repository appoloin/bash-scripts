...
NAME="ultima-viitm-the-black-gate-the-forge-of-virtue"
GAME_NAME="$NAME.sh"
...
main(){
    ...
    EXE_ISLE_PATH=$(find "$TEMP_FOLDER" -type f -iname "*isle*.exe" | head -n 1)
    EXE_BLACK_PATH=$(find "$TEMP_FOLDER" -type f -iname "*black*.exe" | head -n 1)
