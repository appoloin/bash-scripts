...
ENGINE_DATA="$HOME/.var/app/io.github.dxx_rebirth.dxx-rebirth/data/.d1x-rebirth/"
FILE_FILTER=""
MUSIC_URL="https://www.dropbox.com/scl/fi/h1n2jp3mzob47o4154e4e/d1x-rebirth-addons.7z.001?rlkey=t0oos0u0z3xyt1xpx8ibahm15&st=nijjlh7q&dl=1"
MUSIC_NAME="d1x-rebirth addons.7z.001"
...
main(){
    ...
    find "$ROMs_FOLDER/$GAME_NAME/app/Descent"  -mindepth 1 -maxdepth 1 -name "*"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME" \;
    ...
    echo -e "#!/bin/bash\n\nflatpak run $ENGINE_NAME d1x" > "$ROMs_FOLDER/$GAME_NAME/$GAME_NAME"
