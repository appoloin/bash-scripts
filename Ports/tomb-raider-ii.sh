...
FILE_FILTER=""
MUSIC_URL="https://www.dropbox.com/scl/fi/dan5kwn7rla1elprjrvfo/musicTR2.zip?rlkey=enx8bvuycglb00yk6pqfg52o7&st=3k5104va&dl=0"
MUSIC_ARCHIVE_NAME="musicTR2.zip"
...
main(){
    ...
    find "$TEMP_FOLDER/app/data" -mindepth 1 -maxdepth 1 -iname "main.sfc"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/games/tr2" \;
    ...
    find "$TEMP_FOLDER/new_music/music"  -mindepth 1 -maxdepth 1 -name "*"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME/games/tr2/music" \;


    touch "$ROMs_FOLDER/$GAME_NAME/noload.txt"
    #Create ES_DE launch file with engine code
    echo -e "#!/bin/bash\n\n$ROMs_FOLDER/$GAME_NAME/$ENGINE_EXE --mod tr2" > "$ROMs_FOLDER/$GAME_NAME/$GAME_NAME"
