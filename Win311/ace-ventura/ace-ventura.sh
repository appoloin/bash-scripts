...
CONF_FILE_NAME="ace-ventura.conf"
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/ace-ventura/ace-ventura.conf"
