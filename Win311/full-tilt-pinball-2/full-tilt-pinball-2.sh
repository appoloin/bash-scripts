...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/full-tilt-pinball-2/full-tilt-pinball-2.conf"
CONF_FILE_NAME="full-tilt-pinball-2.conf"
