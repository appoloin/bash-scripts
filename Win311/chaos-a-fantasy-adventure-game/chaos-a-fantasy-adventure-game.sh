...
#Game        : Chaos - A Fantasy Adventure Game
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/chaos-a-fantasy-adventure-game/chaos-a-fantasy-adventure-game.conf"
CONF_FILE_NAME="chaos-a-fantasy-adventure-game.conf"
