...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/in-the-1st-degree/in-the-1st-degree.conf"
CONF_FILE_NAME="in-the-1st-degree.conf"
