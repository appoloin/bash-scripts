...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/nemesis-the-wizardry-adventure/nemesis-the-wizardry-adventure.conf"
CONF_FILE_NAME="nemesis-the-wizardry-adventure.conf"
