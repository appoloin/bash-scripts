...
#Game        : Bermuda Syndrome
#
#Source      : EXOODS Archive  
#
...
CONF_FILE_NAME="bermuda-syndrome.conf"
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/bermuda-syndrome/bermuda-syndrome.conf"
