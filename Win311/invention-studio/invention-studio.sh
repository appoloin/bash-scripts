...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/invention-studio/invention-studio.conf"
CONF_FILE_NAME="invention-studio.conf"
