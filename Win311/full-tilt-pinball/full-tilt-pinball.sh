...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/full-tilt-pinball/full-tilt-pinball.conf"
CONF_FILE_NAME="full-tilt-pinball.conf"
