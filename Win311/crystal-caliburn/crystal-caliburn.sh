...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/crystal-caliburn/crystal-caliburn.conf"
CONF_FILE_NAME="crystal-caliburn.conf"
