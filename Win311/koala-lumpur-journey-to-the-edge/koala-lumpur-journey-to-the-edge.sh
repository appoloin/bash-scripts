...
#Game        : Koala Lumpur - Journey to the Edge
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/koala-lumpur-journey-to-the-edge/koala-lumpur-journey-to-the-edge.conf"
CONF_FILE_NAME="koala-lumpur-journey-to-the-edge.conf"
