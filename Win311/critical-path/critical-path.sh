...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/Win311/critical-path/critical-path.conf"
CONF_FILE_NAME="critical-path.conf"
