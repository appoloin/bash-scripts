...
main(){
    ...
    SWARLCK=$(find "$TEMP_FOLDER" -type d -iname "SSWARLCK" | head -n 1)
    find "$SWARLCK" -mindepth 1 -maxdepth 1 -name "*" -exec cp {} -r "$ROMs_FOLDER/$GAME_NAME" \;
