...
main(){
    ...
    find "$TEMP_FOLDER/ENGLISH"  -mindepth 1 -maxdepth 1 -name "*"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME" \;
    find "$TEMP_FOLDER/app/ENGLISH"  -mindepth 1 -maxdepth 1 -name "*"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME" \;
    find "$TEMP_FOLDER/__support/save/ENGLISH"  -mindepth 1 -maxdepth 1 -name "*"  -exec mv {} "$ROMs_FOLDER/$GAME_NAME" \;
