...
ELEMENT_1=("Colossal Cave Adventure" "colossaladvjod.scummvm" "colossaladvjod" "-ir!COLOSSAL.*" "")
ELEMENT_2=("Adventure Quest" "adventurequest.scummvm" "adventurequest" "-ir!QUEST.*" "")
ELEMENT_3=("Dungeon Adventure" "dungeonadvjod.scummvm" "dungeonadvjod" "-ir!DUNGEON.*" "")
