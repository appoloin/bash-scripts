...
#Game        : James Bond 007 - The Stealth Affair
#
#Source      : Rip
#
#Runner      : Scummvm
...
FILE_FILTER="-ir!*.DAT -ir!*.dat -ir!EGOUBASE -ir!egoubase -ir!LABYBASE -ir!labybase -ir!PROC* -ir!proc* -ir!RSC* -ir!rsc* -ir!SON* -ir!son* -ir!VOL* -ir!vol* -ir!*.PAL -ir!*.pal -ir!SD* -ir!sd*  -ir!SINTRO2 -ir!sintro2"
