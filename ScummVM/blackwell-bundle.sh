...
ELEMENT_1=("The Blackwell Legacy" "blackwell1.scummvm" "blackwell1" "Legacy" "")
ELEMENT_2=("Blackwell Unbound" "blackwell2.scummvm" "blackwell2" "Unbound" "")
ELEMENT_3=("The Blackwell Convergence" "blackwell3.scummvm" "blackwell3" "Convergence" "")
ELEMENT_4=("The Blackwell Deception" "blackwell4.scummvm" "blackwell4" "Deception" "")
GAME_DATA=(
    ELEMENT_1[@]
    ELEMENT_2[@]
    ELEMENT_3[@]
...
RADIO_OPTION=0 #EXE = 1;  Archive = 2
