...
FILE_FILTER="-ir!GSPTR30 -ir!gsptr30 -ir!ICON.DAT -ir!icon.dat -ir!MIDPAK.AD ir!midpak.ad -ir!SETUP.SHR -ir!setup.shr -ir!SIMON2.GME -ir!simon2.gme -ir!SIMON2.VOC -ir!simon2.voc -ir!STRIPPED.TXT -ir!stripped.txt -ir!TBLLIST -ir!tbllist"
