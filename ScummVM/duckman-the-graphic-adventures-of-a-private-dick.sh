...
SCUMMVM_NAME="duckman"
GAME_NAME="$SCUMMVM_NAME.scummvm"
TEMP_FOLDER="$ROMs_FOLDER/$GAME_NAME/temp"
FILE_FILTER="-ir!MUSIC -ir!SFX -ir!VIDEO -ir!VIDEO -ir!DUCKMAN.GAM"
...
main(){
    ...
    find "$TEMP_FOLDER/DATA" -mindepth 1 -maxdepth 1 -name "*"  -exec cp {} -r "$ROMs_FOLDER/$GAME_NAME" \;
