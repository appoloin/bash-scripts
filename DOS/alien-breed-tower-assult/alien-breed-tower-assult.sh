...
#Game        : Alien Breed Tower Assult
#
#Source      : GOG installer
#
#Runner      : DosBox
#
#Description : This script will extract the GOG installer into ROMs/do folder .
#              1: Get Game file
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/alien-breed-tower-assult/alien-breed-tower-assult.conf"
CONF_FILE_NAME="alien-breed-tower-assult.conf"
...
TEMP_FOLDER="$HOME/Games/ROMs/dos/alien-breed-tower-assult.conf/temp"
