...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/lemmings-2-the-tribes/lemmings-2-the-tribes.conf"
CONF_FILE_NAME="lemmings-2-the-tribes.conf"
FILE_FILTER=""
