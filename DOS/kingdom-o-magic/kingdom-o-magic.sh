...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/kingdom-o-magic/kingdom-o-magic.conf"
CONF_FILE_NAME="kingdom-o-magic.conf"
