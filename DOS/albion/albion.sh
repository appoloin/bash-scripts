...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/albion/albion.conf"
CONF_FILE_NAME="albion.conf"
...
main(){
    ...
    if [ $? -ne 0 ]; then
        ...
        rm -f -r "$ROMs_FOLDER/$GCONF_FILE_NAME"
        exit 1
    fi
