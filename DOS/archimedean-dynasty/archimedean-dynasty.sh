...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/archimedean-dynasty/archimedean-dynasty.conf"
CONF_FILE_NAME="archimedean-dynasty.conf"
...
main(){
    ...
    find "$TEMP_FOLDER/app"  -maxdepth 1 -name "*"  -exec cp {} -r "$ROMs_FOLDER/$CONF_FILE_NAME" \;
