...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/eric-the-unready/eric-the-unready.conf"
CONF_FILE_NAME="eric-the-unready.conf"
