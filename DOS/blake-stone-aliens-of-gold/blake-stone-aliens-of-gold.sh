...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/blake-stone-aliens-of-gold/blake-stone-aliens-of-gold.conf"
CONF_FILE_NAME="blake-stone-aliens-of-gold.conf"
