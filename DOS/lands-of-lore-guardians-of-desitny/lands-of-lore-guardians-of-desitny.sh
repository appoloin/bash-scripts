...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/lands-of-lore-guardians-of-desitny/lands-of-lore-guardians-of-desitny.conf"
CONF_FILE_NAME="lands-of-lore-guardians-of-desitny.conf"
...
main(){
    ...
    "$TEMP_FOLDER/$INNO_EXE" --include "app/Lands of Lore 2"  -d "$TEMP_FOLDER" "$EXE_PATH"
    if [ $? -ne 0 ]; then
