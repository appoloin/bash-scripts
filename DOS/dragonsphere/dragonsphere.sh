...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/dragonsphere/dragonsphere.conf"
CONF_FILE_NAME="dragonsphere.conf"
