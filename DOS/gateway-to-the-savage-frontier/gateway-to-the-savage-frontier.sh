...
#Game        : Gateway to the Savage Frontier
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/gateway-to-the-savage-frontier/gateway-to-the-savage-frontier.conf"
CONF_FILE_NAME="gateway-to-the-savage-frontier.conf"
