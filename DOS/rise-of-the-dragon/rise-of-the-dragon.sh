...
main(){
    ...
    find "$ROMs_FOLDER/$CONF_FILE_NAME/app" -name "*"  -exec mv {} "$ROMs_FOLDER/$CONF_FILE_NAME" \;
    find "$ROMs_FOLDER/$CONF_FILE_NAME/__support/save" -name "*" -exec mv {}  "$ROMs_FOLDER/$CONF_FILE_NAME" \;
