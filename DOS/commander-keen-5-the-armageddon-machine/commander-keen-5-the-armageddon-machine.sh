...
#Game        : Commander Keen 5 - The Armageddon Machine
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/commander-keen-5-the-armageddon-machine/commander-keen-5-the-armageddon-machine.conf"
CONF_FILE_NAME="commander-keen-5-the-armageddon-machine.conf"
