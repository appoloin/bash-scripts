...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/monster-bash/monster-bash.conf"
CONF_FILE_NAME="monster-bash.conf"
