...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/demons-forge/demons-forge.conf"
CONF_FILE_NAME="demons-forge.conf"
