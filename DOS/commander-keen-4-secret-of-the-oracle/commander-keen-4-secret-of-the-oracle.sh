...
#Game        : Commander Keen 4 - Secrets of the Oracle
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/commander-keen-4-secret-of-the-oracle/commander-keen-4-secret-of-the-oracle.conf"
CONF_FILE_NAME="commander-keen-4-secret-of-the-oracle.conf"
