...
#Game        : Dick Tracy The Crime Solving Adventure
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/dick-tracy-the-crime-solving-adventure/dick-tracy-the-crime-solving-adventure.conf"
CONF_FILE_NAME="dick-tracy-the-crime-solving-adventure.conf"
