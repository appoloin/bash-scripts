...
#Game        : Biing Sex Intrigue and Scalpels
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/biing-sex-intrigue-and-scalpels/biing-sex-intrigue-and-scalpels.conf"
CONF_FILE_NAME="biing-sex-intrigue-and-scalpels.conf"
...
TEMP_FOLDER="$HOME/Games/ROMs/dos/$CONF_FILE_NAME/temp"
