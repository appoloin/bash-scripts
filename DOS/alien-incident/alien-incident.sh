...
GAME_DRIVE_C_FOLDER="AI"
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/alien-incident/alien-incident.conf"
CONF_FILE_NAME="alien-incident.conf"
