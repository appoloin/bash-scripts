...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/lord-avalot-dargent/lord-avalot-dargent.conf"
CONF_FILE_NAME="lord-avalot-dargent.conf"
FILE_FILTER=""
