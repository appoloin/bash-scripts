...
#Game        : legends-of-murder-collection
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/legends-of-murder-collection/legends-of-murder-collection.conf"
CONF_FILE_NAME="legends-of-murder-collection.conf"
