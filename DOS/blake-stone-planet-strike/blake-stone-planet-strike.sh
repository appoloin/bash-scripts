...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/blake-stone-planet-strike/blake-stone-planet-strike.conf"
CONF_FILE_NAME="blake-stone-planet-strike.conf"
