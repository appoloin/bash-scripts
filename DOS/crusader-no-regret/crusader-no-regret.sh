...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/crusader-no-regret/crusader-no-regret.conf"
CONF_FILE_NAME="crusader-no-regret.conf"
