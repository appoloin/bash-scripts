...
#Game        : Desert Strike - Return to the Gulf
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/desert-strike-return-to-the-gulf/desert-strike-return-to-the-gulf.conf"
CONF_FILE_NAME="desert-strike-return-to-the-gulf.conf"
