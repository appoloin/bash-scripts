...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/fantasy-world-dizzy/fantasy-world-dizzy.conf"
CONF_FILE_NAME="fantasy-world-dizzy.conf"
