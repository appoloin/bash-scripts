...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/mortal-kombat-1/mortal-kombat-1.conf"
CONF_FILE_NAME="mortal-kombat-1.conf"
