...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/dungeon-hack/dungeon-hack.conf"
CONF_FILE_NAME="dungeon-hack.conf"
