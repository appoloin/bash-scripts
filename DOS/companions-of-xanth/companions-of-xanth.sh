...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/companions-of-xanth/companions-of-xanth.conf"
CONF_FILE_NAME="companions-of-xanth.conf"
