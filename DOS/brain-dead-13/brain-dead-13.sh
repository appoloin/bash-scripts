...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/brain-dead-13/brain-dead-13.conf"
CONF_FILE_NAME="brain-dead-13.conf"
