...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/maupiti-island/maupiti-island.conf"
CONF_FILE_NAME="maupiti-island.conf"
FILE_FILTER=""
