...
#Game        : F-117A Nighthawk Stealth Fighter 2.0
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/f-117a-nighthawk-stealth-fighter-20/f-117a-nighthawk-stealth-fighter-20.conf"
CONF_FILE_NAME="f-117a-nighthawk-stealth-fighter-20.conf"
