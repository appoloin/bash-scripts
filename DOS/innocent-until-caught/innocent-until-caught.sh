...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/innocent-until-caught/innocent-until-caught.conf"
CONF_FILE_NAME="innocent-until-caught.conf"
