...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/evidence-the-last-report/evidence-the-last-report.conf"
CONF_FILE_NAME="evidence-the-last-report.conf"
