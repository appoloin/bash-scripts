...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/james-bond-007-goldfinger/james-bond-007-goldfinger.conf"
CONF_FILE_NAME="james-bond-007-goldfinger.conf"
