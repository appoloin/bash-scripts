...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/command-conquer/command-conquer.conf"
CONF_FILE_NAME="command-conquer.conf"
