...
#Game        : Might and Magic II - Gates to Another World
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/might-and-magic-ii-gates-to-another-world/might-and-magic-ii-gates-to-another-world.conf"
CONF_FILE_NAME="might-and-magic-ii-gates-to-another-world.conf"
...
main(){
    ...
    find "$ROMs_FOLDER/$CONF_FILE_NAME/__support" -mindepth 1 -maxdepth 1 -name "*"  -exec cp {} -r "$ROMs_FOLDER/$CONF_FILE_NAME" \;
