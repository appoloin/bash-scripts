...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/gateway-ii-homeworld/gateway-ii-homeworld.conf"
CONF_FILE_NAME="gateway-ii-homeworld.conf"
