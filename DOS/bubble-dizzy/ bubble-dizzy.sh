...
GAME_DRIVE_C_FOLDER="BubbleDi"
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/bubble-dizzy/bubble-dizzy.conf"
CONF_FILE_NAME="bubble-dizzy.conf"
