...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/chewy-escape-from-f5/chewy-escape-from-f5.conf"
CONF_FILE_NAME="chewy-escape-from-f5.conf"
