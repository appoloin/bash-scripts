...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/dracula-unleashed/dracula-unleashed.conf"
CONF_FILE_NAME="dracula-unleashed.conf"
