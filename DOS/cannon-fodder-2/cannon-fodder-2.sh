...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/cannon-fodder-2/cannon-fodder-2.conf"
CONF_FILE_NAME="cannon-fodder-2.conf"
