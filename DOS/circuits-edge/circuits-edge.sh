...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/circuits-edge/circuits-edge.conf"
CONF_FILE_NAME="circuits-edge.conf"
