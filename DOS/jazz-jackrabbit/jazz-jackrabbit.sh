...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/jazz-jackrabbit/jazz-jackrabbit.conf"
CONF_FILE_NAME="jazz-jackrabbit.conf"
