...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/menzoberranzan/menzoberranzan.conf"
CONF_FILE_NAME="menzoberranzan.conf"
...
main(){
    ...
    find "$ROMs_FOLDER/$CONF_FILE_NAME" -mindepth 1 -maxdepth 1 -name "*"  -exec cp {} -r "$ROMs_FOLDER/$CONF_FILE_NAME" \;
