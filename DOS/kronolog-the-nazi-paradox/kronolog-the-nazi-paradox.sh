...
#Game        : Kronolog - The Nazi Paradox
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/kronolog-the-nazi-paradox/kronolog-the-nazi-paradox.conf"
CONF_FILE_NAME="kronolog-the-nazi-paradox.conf"
