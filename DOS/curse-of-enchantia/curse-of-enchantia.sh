...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/curse-of-enchantia/curse-of-enchantia.conf"
CONF_FILE_NAME="curse-of-enchantia.conf"
