...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/heavens-dawn/heavens-dawn.conf"
CONF_FILE_NAME="heavens-dawn.conf"
