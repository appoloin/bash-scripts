...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/little-big-adventure-2/little-big-adventure-2.conf"
CONF_FILE_NAME="little-big-adventure-2.conf"
