...
#Game        : Geekwad - Games of the Galaxy
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/geekwad-games-of-the-galaxy/geekwad-games-of-the-galaxy.conf"
CONF_FILE_NAME="geekwad-games-of-the-galaxy.conf"
