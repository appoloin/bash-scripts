...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/heroes-of-might-and-magic/heroes-of-might-and-magic.conf"
CONF_FILE_NAME="heroes-of-might-and-magic.conf"
