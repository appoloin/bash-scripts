...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/jagged-alliance/jagged-alliance.conf"
CONF_FILE_NAME="jagged-alliance.conf"
