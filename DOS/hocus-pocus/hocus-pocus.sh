...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/hocus-pocus/hocus-pocus.conf"
CONF_FILE_NAME="hocus-pocus.conf"
...
main(){
    ...
    find "$ROMs_FOLDER/$CONF_FILE_NAME/__support/sav" -mindepth 1 -maxdepth 1 -name "*"  -exec cp {} -r "$ROMs_FOLDER/$CONF_FILE_NAME" \;
