...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/command-and-conquer-red-alert/command-and-conquer-red-alert.conf"
CONF_FILE_NAME="ccommand-and-conquer-red-alert.conf"
