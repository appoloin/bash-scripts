...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/disneys-the-jungle-book/disneys-the-jungle-book.conf"
CONF_FILE_NAME="disneys-the-jungle-book.conf"
