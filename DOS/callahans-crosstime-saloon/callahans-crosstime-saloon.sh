...
#Game        : Callahan's Crosstime Saloon
#
...
GAME_DRIVE_C_FOLDER="callahan"
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/callahans-crosstime-saloon/callahans-crosstime-saloon.conf"
CONF_FILE_NAME="callahans-crosstime-saloon.conf"
