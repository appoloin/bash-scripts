...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/alien-breed/alien-breed.conf"
CONF_FILE_NAME="alien-breed.conf"
...
TEMP_FOLDER="$HOME/Games/ROMs/dos/alien-breed.conf/temp"
