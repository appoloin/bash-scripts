...
#Game        : The Fantastic Adventures of Dizzy
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/fantastic-dizzy/fantastic-dizzy.conf"
CONF_FILE_NAME="fantastic-dizzy.conf"
