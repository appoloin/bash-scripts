...
#Game        : Carmageddon Max Pack
#
#Source      : EXO installer
#
#Runner      : DosBox
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/carmageddon-max-pack/carmageddon-max-pack.conf"
CONF_FILE_NAME="carmageddon-max-pack.conf"
