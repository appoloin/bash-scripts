...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/might-and-magic-world-of-xeen/might-and-magic-world-of-xeen.conf"
CONF_FILE_NAME="might-and-magic-world-of-xeen.conf"
