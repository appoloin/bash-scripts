...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/chamber-of-the-sci-mutant-priestess/chamber-of-the-sci-mutant-priestess.conf"
CONF_FILE_NAME="chamber-of-the-sci-mutant-priestess.conf"
