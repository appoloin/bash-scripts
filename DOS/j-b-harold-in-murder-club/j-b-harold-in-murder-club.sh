...
#Game        : J.B. Harold in Murder Club
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/j-b-harold-in-murder-club/j-b-harold-in-murder-club.conf"
CONF_FILE_NAME="j-b-harold-in-murder-club.conf"
