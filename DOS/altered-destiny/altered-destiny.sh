...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/altered-destiny/altered-destiny.conf"
CONF_FILE_NAME="altered-destiny.conf"
...
TEMP_FOLDER="$HOME/Games/ROMs/dos/altered-destiny.conf/temp"
