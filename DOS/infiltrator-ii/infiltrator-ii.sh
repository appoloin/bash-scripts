...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/infiltrator-ii/infiltrator-ii.conf"
CONF_FILE_NAME="infiltrator-ii.conf"
