...
#Game        : James Bond 007 - A View to Kill
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/james-bond-007-a-view-to-a-kill-the-computer-game/james-bond-007-a-view-to-a-kill-the-computer-game.conf"
CONF_FILE_NAME="james-bond-007-a-view-to-a-kill-the-computer-game.conf"
