...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/d-slash-generation/d-slash-generation.conf"
CONF_FILE_NAME="d-slash-generation.conf"
