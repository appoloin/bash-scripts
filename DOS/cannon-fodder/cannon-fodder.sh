...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/cannon-fodder/cannon-fodder.conf"
CONF_FILE_NAME="cannon-fodder.conf"
