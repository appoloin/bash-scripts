...
#Game        : Jane Advanced Strike Fighters
#
...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/janes-advanced-strike-fighters/janes-advanced-strike-fighters.conf"
CONF_FILE_NAME="janes-advanced-strike-fighters.conf"
