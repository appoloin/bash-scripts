...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/oh-no-more-lemmings/oh-no-more-lemmings.conf"
CONF_FILE_NAME="oh-no-more-lemmings.conf"
FILE_FILTER=""
