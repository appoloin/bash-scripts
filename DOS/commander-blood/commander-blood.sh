...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/commander-blood/commander-blood.conf"
CONF_FILE_NAME="commander-blood.conf"
