...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/kingdom-ii-shadoan/kingdom-ii-shadoan.conf"
CONF_FILE_NAME="kingdom-ii-shadoan.conf"
