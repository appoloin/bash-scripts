...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/chronomaster/chronomaster.conf"
CONF_FILE_NAME="chronomaster.conf"
