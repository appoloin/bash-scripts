...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/disneys-aladdin/disneys-aladdin.conf"
CONF_FILE_NAME="disneys-aladdin.conf"
