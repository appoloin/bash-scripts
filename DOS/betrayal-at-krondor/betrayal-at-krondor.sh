...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/betrayal-at-krondor/betrayal-at-krondor.conf"
CONF_FILE_NAME="betrayal-at-krondor.conf"
