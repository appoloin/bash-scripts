...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/les-manley-in-lost-in-la/les-manley-in-lost-in-la.conf"
CONF_FILE_NAME="les-manley-in-lost-in-la.conf"
