...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/blues-brothers/blues-brothers.conf"
CONF_FILE_NAME="blues-brothers.conf"
