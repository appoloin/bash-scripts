...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/bloodnet/bloodnet.conf"
CONF_FILE_NAME="bloodnet.conf"
...
main(){
    ...
    mkdir -p "$ROMs_FOLDER/$CONF_FILE_NAME/SAVE"
