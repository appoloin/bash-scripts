...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/alone-in-the-dark-3/alone-in-the-dark-3.conf"
CONF_FILE_NAME="alone-in-the-dark-3.conf"
...
TEMP_FOLDER="$HOME/Games/ROMs/dos/alone-in-the-dark-3.conf/temp"
