...
CONF_FILE_URL="https://raw.githubusercontent.com/appoloin/bash-scripts/refs/heads/main/DOS/last-half-of-darkness-2/last-half-of-darkness-2.conf"
CONF_FILE_NAME="last-half-of-darkness-2.conf"
FILE_FILTER=""
...
main(){
    ...
    extract_archive "$FILES" "$ROMs_FOLDER/$CONF_FILE_NAME/" "x" "$FILE_FILTER"
    if [ $? -ne 0 ]; then 
